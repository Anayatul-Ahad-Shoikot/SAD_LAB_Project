...
<body>
    ...
    <div class="login-container">
        <div class="container" id="form-container">
            ...
            <div class="slide hidden">
                <form id="password-form" action="/BackEnd/forgetpass_BE.php" method="POST">
        ...
        <span><a href="/FrontEnd/loggedOut/login.php" class="goback">Go Back</a></span>
    </div>

    <script src="/FrontEnd/js/forgetpass.js"></script>
</body>
