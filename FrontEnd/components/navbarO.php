<nav>
    <div class="top-nav">
        ...
        <ul class="auth-links">
            <li><a href="/FrontEnd/loggedIn/organizationpage/profile.php">My account</a></li>
    ...
    <div class="bottom-nav">
        ...
        <ul class="main-nav">
            <li><a href="/FrontEnd/loggedIn/organizationpage/home.php" class="active">Home</a></li>
            <span class="h-bar"></span>
            <li><a href="/FrontEnd/loggedIn/organizationpage/organization.php">Organizations</a></li>
            <span class="h-bar"></span>
            <li><a href="#">Seminars</a></li>
            <span class="h-bar"></span>
            <li><a href="#">Join Us</a></li>
            <span class="h-bar"></span>
            <li><a href="/FrontEnd/loggedIn/organizationpage/aboutus.php">About Us</a></li>
