...
<head>
    ...
    <link rel="stylesheet" href="/FrontEnd/css/donation.css">
...
<body>
    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="row">
                <div class="don-box">
                    <img src="/Icons&logos/salary.png" alt="img">
                    <h3>Fund</h3>
                    <p>Supports our organization's growth and development</p>
                    <a href="donation_form.php?org_id=<?php echo $_GET['org_id'] ?>" id="button-30" class="fund">Donate Now</a>
                </div>
                <div class="don-box">
                    <img src="/Icons&logos/shopping-bag.png" alt="img">
                    <h3>Food</h3>
    ...
    <div id="popupForm" class="popup">
        <div class="popup-content">
            ...
            <div class="wrapper">
                <h1>Donation Form</h1>
                <form action="/BackEnd/donation_submit_BE.php" method="POST">
    ...
    <script src="/FrontEnd/js/donation_form.js"></script>
